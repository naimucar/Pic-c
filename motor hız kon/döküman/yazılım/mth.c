...
///////////////////////////////////////////////////////////////////////////////////////////////////
// program timer2 sayacýnýn  T1CKI  ucundan gelen darbeleri  saymasý esasý ile çalýþýr     /////              
// devir sayýsý deiþkeni ve timer1 yani ayný adrese tanýmlý olan sayac deðiþkeni sýfýrlanýr   /////
// program 100 milisaniye aralýklarla 1 saniye bekletilir. bu esnada TMR0 gelen palsleri      /////
// saymaya devam eder. toplam 1 saniye sonunda tmr1 (sayac) ýn deðeri diskte 24 delik olduðu  /////
...
// lünün yapýlmasýdýr.RA0 kanalý ilgili hýz kontrol potunun ayar ucuna baðlanýr.   /////
...
//////////////////////////////////////////////////////////////////////////////////////
   ...
   {                                                   
   delay_ms(100);
      if(input(pin_d3)) {goto ana_p;}  // durdurma butonuna basýldý ise ana_p ye git
   }
/////////////////////////////////////////////////////////////////////////////////////
sayac=get_timer1(); 
